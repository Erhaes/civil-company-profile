        ...
        <div className="max-w-3xl">
          <span className="gradient-to-r text-dark-base from-blue-quaternary to-light-base bg-gradient-to-br flex items-center gap-2 mb-4 w-fit py-1 px-3 rounded-md">
            ...
            <p className="extra-small-font-size">
              Berbagai Pengujian di Teknik Sipil Unsoed
            </p>
          </span>
          <h1 className="font-bold mb-1">
            Pengujian di Laboratorium Teknik Sipil Unsoed
          </h1>
          <p>
            Laboratorium Teknik Sipil Unsoed memiliki berbagai fasilitas dan
            layanan pengujian yang dapat membantu mahasiswa, dosen, dan industri
            dalam melakukan penelitian dan pengembangan di bidang teknik sipil.
          </p>
        </div>
      </div>
    </section>
