          ...
          <div className="flex flex-col md:flex-row gap-8">
            ...
            <div className="md:w-1/2">
                ...
                <div className="mb-8">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <span className="text-sm text-blue-200">
                      {facility.tests.length} total pengujian
                    </span>
                  </div>
                  <div className="space-y-3">
                    {facility.tests.slice(0, 4).map((test) => (
                      <div
                        key={test.id}
                        className="bg-light-base bg-opacity-15 backdrop-blur-sm rounded-lg p-4 border border-white border-opacity-20 hover:bg-opacity-20 transition-all duration-200"
                      >
                        <div className="flex justify-between items-start mb-2">
                          <h4 className="font-medium text-dark-base text-sm">
                            {test.name}
                          </h4>
                          <span className="bg-blue-500 bg-opacity-30 text-blue-100 text-xs px-2 py-1 rounded-full font-medium">
                          ...
                          >
                            <div
                              className={`w-1.5 h-1.5 rounded-full ${
                                test.is_active ? "bg-green-300" : "bg-red-300"
                              }`}
                            ></div>
                    ...
                    {facility.tests?.length > 4 && (
                      <div className="text-center pt-2">
                        <span className="text-sm text-blue-600 bg-light-base bg-opacity-10 px-3 py-1 rounded-full">
                          +{facility.tests?.length - 4} pengujian lainnya
                        </span>
                      </div>
                    )}
                  </div>
              ...
              {/* {facility.packages?.length > 0 && (
                <div>
                  <div className="flex items-center justify-between mb-4">
                    <h3 className="text-xl font-semibold">Paket Layanan</h3>
                    <span className="text-sm text-green-200">
                      {facility.packages.length} paket tersedia
                    </span>
                  </div>
                  <div className="space-y-3">
                    {facility.packages.map((pkg) => (
                      <div
                        key={pkg.id}
                        className="bg-gradient-to-r from-green-500 from-opacity-15 to-blue-500 to-opacity-15 backdrop-blur-sm rounded-lg p-4 hover:from-opacity-20 hover:to-opacity-20 transition-all duration-200"
                      >
                        <div className="flex justify-between items-start mb-3">
                          <h4 className="font-semibold text-light-base">
                            {pkg.name}
                          </h4>
                          <div className="text-right">
                            <div className="bg-green-500 bg-opacity-30 text-green-100 text-sm px-3 py-1 rounded-full font-medium">
                              Rp {pkg.price.toLocaleString("id-ID")}
                            </div>
                          </div>
                        </div>
                        <p className="text-sm text-light-base leading-relaxed">
                          {pkg.description}
                        </p>
                        <div className="flex items-center justify-between mt-3 pt-3 border-t border-white border-opacity-20">
                          ...
                          <button className="text-xs text-green-100 hover:text-green-100 font-medium transition-colors">
                            Lihat Detail →
                          </button>
                        </div>
                      </div>
        ...
        <section className="bg-gradient-to-b from-gray-50 to-white section-padding-x py-8">
          <div className="max-w-screen-xl mx-auto">
            <div className="text-center mb-4">
              {/* <div className="inline-flex items-center justify-center w-16 h-16 bg-sipil-base bg-opacity-10 rounded-full mb-4">
                <svg
                  className="w-8 h-8 text-sipil-base"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
              ...
              {facility.tests.map((test, index) => (
                ...
                >
                  ...
                  <div className="relative">
                    ...
                    {/* <a href={`/pengujian`} className="w-full bg-gradient-to-r from-sipil-base to-blue-600 text-white font-medium py-3 px-4 rounded-lg hover:shadow-lg transition-all duration-300 group-hover:from-sipil-base/90 group-hover:to-blue-600/90">
              ...
              {facility.packages.map((pkg, index) => (
                ...
                >
                  ...
                  <div className="relative">
                    ...
                    {/* <button className="w-full bg-gradient-to-r from-green-600 to-blue-600 text-white font-medium py-4 px-6 rounded-xl hover:shadow-lg transition-all duration-300 group-hover:from-green-700 group-hover:to-blue-700">
